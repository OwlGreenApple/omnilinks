            ...
            <div class="tab-content">
              ...
              <div role="tabpanel" class="tab-pane fade in active show" id="link">
                <form method="post" id="savelink" action="{{url('save-link')}}" novalidate>
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-11 col-11">
                            <div class="input-stack">
                              ...
                              <input type="text" name="title[]" ng-model="link1" value="" placeholder="Title" class="form-control">
                  ...
                  <div class="as">
                    <hr class="own">
                    <button type="button" id="btn-save-link" class="btn btn-primary btn-biolinks " style="border-radius: 51px;">
