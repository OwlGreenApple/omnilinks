            ...
            <div class="tab-content">
              ...
              <div role="tabpanel" class="tab-pane fade in active show" id="link">
                <form method="post" id="savelink" action="{{url('save-link')}}" novalidate>
                  ...
                  <div class="as">
                    <button type="button" id="btn-save-link" class="btn btn-primary btn-biolinks " style="float: right;">
                ...
                <form method="post" id="saveTemplate" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                    ...
                    <div class="as">
                      ...
                      <button type="button" class="btn btn-primary btn-biolinks" id="savetemp" style="float: right;"><i class="far fa-save" style="margin-right:5px;"></i>SAVE</button>
                    </div>
                  </div>
                </form>
