...
<div class="card noshow">
    <div class="card-body">
        <h1 class="textdash">Buat Omnilinkz pertama Anda<br>Pilih <span style="color:blue;">"BIO LINK"</span> atau <span style="color:blue;">"SINGLE LINK"</h1>
    </div>
</div>
@else
    ...
    <div class="card carddash">
        <div class="card-body link-header" id="linkHeader" dataid="{{$page->id}}" style="cursor:pointer;">
            <div class="row">
                ...
                <div class="col-md-6">
                    <a href="omn.lkz/{{$page->shorten}}" class="getLink">omn.lkz/{{$page->names}} </a><i class="fas fa-copy"></i><br>
                    <span>Title : {{$page->page_title}}</span><br>
                    ...
                    <p>Created On :{{date("F d,Y", strtotime($page->created_at))}}</p>
                </div>
                <div class="col-md-2">
        ...
        <div class="card-body content-link hidden" style="display: none;">
            ...
            <div class="row">
                ...
                <div class="col-md-7">
                    <span>Banner</span><br>
                       <i class="fab fa-font-awesome-flag"></i><span> {{$banner->title}}</span><br>
                    </div>
                    <div class="col-md-2">
                        <div class="p-4 bd-highlight"><span>Total Click</span><br></div>
                    </div>
                <div class="col-md-3">
            ...
            <div class="row">
                ...
                <div class="col-md-7">
                    ...
                    @if($page->wa_pixel_id!=0 || !is_null($page->wa_pixel_id))
                    <i class='fab fa-whatsapp'></i><span> Whatsapp</span><br>
                    @endif
                    @if($page->telegram_pixel_id!=0||!is_null($page->telegram_pixel_id))
                    <i class='fab fa-telegram'></i><span> Telegram</span><br>
                    @endif
                    @if($page->skype_pixel_id!=0|| !is_null($page->skype_pixel_id))
                    <i class='fab fa-skype'></i><span> Skype</span><br>
                    @endif
                </div>
                <div class="col-md-2">
                    <div class="p-4 bd-highlight">Total Click</div>
            ...
            <div class="row">
                ...
                <div class="col-md-7">
                    <span>Links</span><br>
                        ...
                        <i class="fas fa-link"></i><span>{{$link->title}}</span><br>
                    </div>
                    <div class="col-md-2">
                        <div class="p-4 bd-highlight"><span>Total Click</span><br></div>
                    </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        $('body').on('click','.btn-deletePage',function(e) {
            e.preventDefault();
            e.stopPropagation();
            var iddeletepages = $(this).attr('deletedataid');
