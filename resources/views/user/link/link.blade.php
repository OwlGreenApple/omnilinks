...
@endif
  ...
  and add more";
      ...
      @if($pages->connect_activrespon > 0)
        <div class="col-lg-7 col-md-12 col-sm-12 col-12 mb-2 text-center header-txt"><h4><b>Form Activrespon</b></h4></div>
      ...
      @if($pages->connect_mailchimp > 0)
        <div class="col-lg-7 col-md-12 col-sm-12 col-12 mb-2 text-center header-txt"><h4><b>Form Mailchimp</b></h4></div>
