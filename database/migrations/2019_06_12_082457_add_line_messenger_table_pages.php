...
class AddLineMessengerTablePages extends Migration
{
    ...
    public function up()
    {
        Schema::table('pages',function(Blueprint $table){
          ...
          $table->integer('line_pixel_id')->default(0)->nullable();
          $table->string('line_logo')->nullable();
          $table->string('messenger_title')->nullable();
          $table->string('messenger_link')->nullable();
          $table->integer('messenger_pixel_id')->default(0)->nullable();
          $table->string('messenger_logo')->nullable();
          $table->integer('line_link_counter')->default(0)->nullable();
          $table->integer('messenger_link_counter')->default(0)->nullable();
        });
    }
